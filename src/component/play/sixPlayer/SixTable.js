...
const SixTable = (props) => {
    ...
    callInput,foldInput,allInput1,allInput2,allInput3,allInput4,allInput5,allInput6
        ...
        ,raiseInput6,cnt,check,call,rai,all,fold,timer1
        } = props;
    return (
        <div className="board">
            <div className="w2p1">
                <div className="g1">
                    ...
                    {data&&(data.data.player[4].fold==2)&&allInput5()}
                    {data&&(data.data.player[4].jokBo==2)&&callInput()}
                    {data&&(data.data.player[4].jokBo==3)&&raiseInput5()}
                    {data&&(data.data.player[4].jokBo==4)&&checkInput()}
                    {show&&playerCard1()}
                ...
                <div className="g2">
                    ...
                    {data&&(data.data.player[3].fold==2)&&allInput4()}
                    {data&&(data.data.player[3].jokBo==2)&&callInput()}
                    {data&&(data.data.player[3].jokBo==3)&&raiseInput4()}
                    {data&&(data.data.player[3].jokBo==4)&&checkInput()}
                ...
                <div className="g3">
                    ...
                    {data&&(data.data.player[2].fold==2)&&allInput3()}
                    {data&&(data.data.player[2].jokBo==2)&&callInput()}
                    {data&&(data.data.player[2].jokBo==3)&&raiseInput3()}
                    {data&&(data.data.player[2].jokBo==4)&&checkInput()}
                    {show&&playerCard3()}
            ...
            <div className ="w2p2">
                <div className ="g4">
                    ...
                    {data&&(data.data.player[5].fold==2)&&allInput6()}
                    {data&&(data.data.player[5].jokBo==2)&&callInput()}
                    {data&&(data.data.player[5].jokBo==3)&&raiseInput6()}
                    {data&&(data.data.player[5].jokBo==4)&&checkInput()}
                ...
                <div className="g5">
                    ...
                    {data&&(data.data.player[0].fold==2)&&allInput1()}
                    {data&&(data.data.player[0].jokBo==2)&&callInput()}
                    {data&&(data.data.player[0].jokBo==3)&&raiseInput1()}
                    {data&&(data.data.player[0].jokBo==4)&&checkInput()}
                ...
                <div className="g6">
                    ...
                    {data&&(data.data.player[1].fold==2)&&allInput2()}
                    {data&&(data.data.player[1].jokBo==2)&&callInput()}
                    {data&&(data.data.player[1].jokBo==3)&&raiseInput2()}
                    {data&&(data.data.player[1].jokBo==4)&&checkInput()}
